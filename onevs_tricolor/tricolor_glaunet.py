...
def custom_loss(y_true, y_pred):
    ...
    dice_3 = (2 * tf.reduce_sum(y_true_cls2 * y_pred_cls2)) / (tf.reduce_sum(K.square(y_true_cls2)) + tf.reduce_sum(K.square(y_pred_cls2)) + K.epsilon())
    ...
    return tf.reshape(tf.reduce_mean(dice_0 + dice_1 + dice_3) / 3.0, (-1,1,1,1))
