    ...
    for f in files:
        if f.lower().endswith('.tif'):
            ...
            for annotator in range(1,7):
                ...
                # Go looking for the top of the optic cup.  Look to the
                # left and right of the center line of the optic disc.
                ...
                print("Annotator " + str(annotator) + ": cup = " + str(cup_length) + ", disc = " + str(disc_length) + ", C/D ratio = " + str(C_D_ratio))
                ...
                img_file.save(f + "_predicted_mask_annnotator" + str(annotator) + ".png")
