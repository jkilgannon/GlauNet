...
in_path_unseg = '/local/repository/testing/cropped/fundus'
in_path_unseg_val = '/local/repository/testing/cropped/fundusval'
in_path_seg = '/local/repository/testing/cropped/mask'
in_path_seg_val = '/local/repository/testing/cropped/maskval'
out_path = '/outgoing/'
#batchsize = 3
batchsize = 1
...
up6 = Conv2DTranspose(neuron_default * 8, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(up6)
...
up7 = Conv2DTranspose(neuron_default * 4, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv6))
...
up8 = Conv2DTranspose(neuron_default * 2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv7))
...
up9 = Conv2DTranspose(neuron_default, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8))
...
model.compile(optimizer = Adam(lr = 1e-4), loss = dice_loss_6, metrics = [inverted_dice_6])
