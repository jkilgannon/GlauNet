...
def main():
    ...
    conv1 = Conv2D(neuron_default, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(input_layer)
    conv1 = Conv2D(neuron_default, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
    drop1 = Dropout(0.25)(pool1)

    conv2 = Conv2D(neuron_default * 2, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop1)
    conv2 = Conv2D(neuron_default * 2, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
    drop2 = Dropout(0.25)(pool2)

    conv3 = Conv2D(neuron_default * 4, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop2)
    conv3 = Conv2D(neuron_default * 4, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)
    drop3 = Dropout(0.25)(pool3)

    conv4 = Conv2D(neuron_default * 8, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop3)
    conv4 = Conv2D(neuron_default * 8, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4)
    drop4 = Dropout(0.25)(pool4)

    ## Center point
    conv5 = Conv2D(neuron_default * 16, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop4)
    conv5 = Conv2D(neuron_default * 16, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv5)
    ...
    conv6 = Conv2D(neuron_default * 8, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop6)
    conv6 = Conv2D(neuron_default * 8, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
    ...
    conv7 = Conv2D(neuron_default * 4, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop7)
    conv7 = Conv2D(neuron_default * 4, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv7)
    ...
    conv8 = Conv2D(neuron_default * 2, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop8)
    conv8 = Conv2D(neuron_default * 2, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    ...
    conv9 = Conv2D(neuron_default, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop9)
    conv9 = Conv2D(neuron_default, kernel_size=kernelsize, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
