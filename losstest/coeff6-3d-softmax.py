...
in_path_unseg = '/worksite/fundus'
in_path_unseg_val = '/worksite/fundusvalidate'
in_path_seg = '/worksite/mask'
in_path_seg_val = '/worksite/maskvalidate'
out_path = '/outgoing/'
#batchsize = 3
batchsize = 1
...
CHKPT = ModelCheckpoint(out_path + 'best_model_incremental_coeff3_3d_softmax.h5', 
                     monitor=monitor_type, 
                     mode='min', 
                     verbose=1, 
                     save_best_only=True)
...
batch_gen = batchmaker('/worksite/fundus/', 
                   '/worksite/mask/', 
                   batchsize, input_size)

batch_gen_val = batchmaker('/worksite/fundusvalidate/', 
                   '/worksite/maskvalidate/', 
                   batchsize, input_size)
...
model.save(out_path + 'last_weights_coeff6_3d_softmax.h5') 
